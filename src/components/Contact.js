...
const LINKS = [
  {
    label: "Email",
    value: "contact.bikashdash@gmail.com",
    href: "mailto:contact.bikashdash@gmail.com",
    icon: (props) => <Mail {...props} size={(props.size || 16) + 3} strokeWidth={1.75} />,
  },
  {
    label: "LinkedIn",
    value: "bikashxdash",
    href: "https://linkedin.com/in/bikashxdash",
  ...
  },
  {
    label: "X",
    value: "@BikashxDash",
    href: "https://x.com/BikashxDash",
    icon: (props) => <XIcon {...props} />,
  },
  {
    label: "Substack",
    value: "@bikashdash",
    href: "https://substack.com/@bikashdash",
    icon: (props) => <SubstackIcon {...props} />,
  }
];
